...
BehindYou::BehindYou()
    : Module("BehindYou", LocalizeString::get("client.module.behindYou.name"),
             LocalizeString::get("client.module.behindYou.desc"), GAME, nokeybind) {
    ...
    addEnumSetting("Perspective", LocalizeString::get("client.module.behindYou.perspective.name"),
                   LocalizeString::get("client.module.behindYou.perspective.desc"), this->pers);
    addSetting("bind", LocalizeString::get("client.module.behindYou.bind.name"),
               LocalizeString::get("client.module.behindYou.bind.desc"), bind);
